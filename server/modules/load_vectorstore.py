...
def describe_image(image_path, filename, page_num):
    """Llama a Replicate con una lógica de reintentos para manejar timeouts."""
    print(f"Describing visuals for {filename}, page {page_num}...")
    
    # --- MEJORA DE ROBUSTEZ: LÓGICA DE REINTENTOS ---
    max_retries = 3
...
def process_page_hybrid(page_data):
    """Procesa una única página en paralelo, generando ambos resúmenes."""
            ...
            for img_index, img in enumerate(page.get_images(full=True)):
                ...
                if xref:
                    ...
                    if img_pix.n - img_pix.alpha >= 3:
                        ...
                        # Llamamos a .save() sobre el objeto de imagen (img_pix), pasándole la ruta
